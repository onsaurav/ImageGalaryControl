...
namespace ImageGalaryControl
{
    public partial class ucImageControl : UserControl
    {
        ...
        private void ucImageControl_Resize(object sender, EventArgs e)
        {
            lvwImage.Size = new System.Drawing.Size((this.Width - 5) , (this.Height - tlsImgGalary.Height -15));
        }
        #endregion

        private void tsbThumbSettings_Click(object sender, EventArgs e)
        {
        ...
        private bool ReGenerateThumbnails(Bitmap source2, string thamb_Name_str_1)
        {
            try
            {
                ...
                {
                    source1 = Properties.Resources.nc_back;
                    _StartX = (float)((_Width / 100) * 8); _StartY = (float)((_Height / 100) * 10); _WidthDec = _StartX * 2; _HeightDec = _StartY * 2;
                }
        ...
        private void cboThambStyle_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                picThambst.Image = Properties.Resources.nc_back;
            }
